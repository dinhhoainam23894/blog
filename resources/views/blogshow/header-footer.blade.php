			...
			<div class="menu-bar">
				<div class="container">
					<div class="navbar-header col-md-2">
				      	<a class="navbar-brand" href="{{ route('blog.index')}}"><i class="fa fa-home"> &nbsp;Home</i></a>
				    </div>
				    <ul class="nav navbar-nav col-md-10">
					    <li class="active"><a href="{{ route('blog.create')}}">Create</a></li>
					    ...
					    @if (Auth::guest())
                       			...
                       			@else
		                            <li class="dropdown">
		                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="color:red;background: white;">
